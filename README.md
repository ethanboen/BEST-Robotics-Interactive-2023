...
Unity® is a trademark of Unity Technologies. The Unity Engine and editor are governed by Unity’s licensing terms.

Third-party assets (including any Unity Asset Store packages or other dependencies) are governed by their respective licenses and are included/used here for demonstration purposes only.
